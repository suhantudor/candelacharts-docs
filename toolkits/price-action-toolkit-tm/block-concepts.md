...
**Blocks** represent the specific candles where institutions initiated large orders. Unlike standard Support & Resistance lines, Blocks are dynamic zones that tell you _where_ the big money entered the market.
...
* **Bullish OB**: The last _down-close_ candle before a massive move up that broke structure.
  * _Psychology_: Institutions sold to engineer liquidity before buying heavily. When price returns, they mitigate their drawdown, causing a bounce.
* **Bearish OB**: The last _up-close_ candle before a massive move down that broke structure.
