...
* **The Core Rule of Liquidity**: When price reaches a liquidity cluster, watch the reaction closely.
  ...
  * If price pushes through the cluster, stalls, but **does not reverse**, the market is likely using that liquidity as fuel to hunt the _next_ cluster further down. We assume continuation until a strong rejection occurs.
